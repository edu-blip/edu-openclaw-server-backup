...
- [trust:1.0|src:direct] **OpenClaw config (2026-03-07)**: memoryFlush active (softThreshold 4000, reserveTokensFloor 40000), memorySearch hybrid (vector 0.7 + text 0.3), contextPruning TTL 5m. All applied after @velvet_shark memory guide audit.

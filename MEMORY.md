...
- [trust:1.0|src:direct] **GitHub backup** (active 2026-03-02): `github.com/edu-blip/edu-openclaw-server-backup` (private). Daily 3am PST cron via `scripts/backup.sh`. Excludes: credentials, MEMORY.md, USER.md, memory/, call transcripts, logs, DB files. Token stored in remote URL. "GitHub Backup First" hold RELEASED.
